...
mod runtime {
    ...
    pub type GhostConsensus = pallet_ghost_consensus::Pallet<Test>;
}
...
parameter_types! {
    ...
    pub const PqcRequired: bool = true;
}
...
impl ExtBuilder {
    pub fn build(self) -> sp_io::TestExternalities {
        ...
        ext.execute_with(|| {
            ...
            pallet_ghost_consensus::CurrentPhase::<Test>::put(
                pallet_ghost_consensus::types::ConsensusPhase::PowMining,
            );
        });
        ext
    }
