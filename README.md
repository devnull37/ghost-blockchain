...
2. **PoS Phase**: Validators selected by stake weight sign blocks
3. **Reward Distribution**: 40% to miners, 60% to stakers
4. **Slashing**: Penalties for double-signing and downtime

## 📊 Key Specifications

- **Block Time**: 5 seconds
- **PoW Algorithm**: Enhanced Blake2-256 (ASIC-resistant)
- **Consensus**: Hybrid PoW + Weighted PoS
- **Token**: Ghost (GHTM)
